...
public class PlayerPropertiesBase : MonoBehaviour
{
    public static PlayerPropertiesBase GetInstance { get; set; }
    public System.Action EvtPlayerPropertiesBaseChange;
    ...
    //触发时机现在是 帧刷新 ----- TODO  TODO  TODO  TODO  TODO  TODO  TODO  TODO  TODO  TODO  TODO  TODO  TODO  TODO  TODO  TODO 
    private void Update()
    {
        EvtPlayerPropertiesBaseChange();
    }
    ...
    //以下为【Base脚本专有】属性，因为不涉及帧更新数据计算
    //以下为【Base脚本专有】属性，因为不涉及帧更新数据计算
    //以下为【Base脚本专有】属性，因为不涉及帧更新数据计算

    //免疫属性 仅作判断使用，具体效果可以不痛 例如无法免疫中毒，可以收到不同的中毒效果（减速/减攻击/减护甲）
    //0:不免疫 1+:免疫
    public short ControlImmune;//免疫任何控制效果(静止，击倒，浮空，眩晕，减速，冰冷，冻结，麻痹，恐惧，任何控制效果的毒药)

    public short MagicImmune;//魔法免疫（魔法伤害）
    public short PhysicalImmune;//物理免疫(物理伤害）

    public short StaticImmune;//静止免疫
    public short KnockDownImmune;//击倒免疫
    public short InAirImmune;//浮空免疫
    public short StunImmune;//能否被眩晕(控制)
    public short SlowImmune;//能否被减速(减速)

    public short FireImmune;//能否火焰免疫

    public short FrostImmune;//能否寒冰免疫
    public short ColdImmune;//能否被冰冷(减速)
    public short FreezeImmune;//能否被冻结(控制)

    public short PosionImmune;//能否毒药免疫(不同效果)

    public short ArcaneImmune;//能否秘法免疫

    public short LightningImmune;//能否闪电免疫
    public short NumbImmune;//能否麻痹免疫

    public short ShadowImmune;//能否暗影免疫
    public short FearImmune;//能否免疫恐惧

    public short HolyImmune;//能否神圣免疫

    public short Invulnerable;//是否无敌
    ...
    void CheckUpgrade()
    {
        ...
        if (Experience >= GameProperties.GetInstance.UpgradeExperience[Level])
        {
            ...
            PlayerPropertiesFinal.GetInstance.CheckProperties();
