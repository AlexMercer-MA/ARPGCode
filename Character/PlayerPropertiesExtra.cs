...
public class PlayerPropertiesExtra : MonoBehaviour {

    static public PlayerPropertiesExtra GetInstance { get; set; }
    ...
    public float _EXCriPhyMeleeChaP;
    ...
    public float _EXCriPhyMeleeDmgP;
    ...
    public float _EXCriPhyRangeChaP;
    ...
    public float _EXCriPhyRangeDmgP;
    ...
    public float _EXFinalDmgBoostP;
    ...
    public float _EXFinalDmgReduceP;
    public float FXFinalDmgReduce { get; set; }


    //【PlayerPropertiesBase】
    //【其余属性】 -【直接修改PlayerPropertiesBase中的数据】
    //免疫属性 
    //基础技能 
    //可装备物品
}
